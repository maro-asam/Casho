  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-white">
      <div className="flex items-center justify-between p-6">
        <Link
          href="/"
          className="flex items-center gap-3 text-xl font-black text-primary"
        >
          <div className="flex items-center justify-center rounded-2xl bg-primary/10 p-3 text-primary">
