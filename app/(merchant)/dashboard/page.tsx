      ...
      <div className="p-6" dir="rtl">
        <Card className="overflow-hidden rounded-[28px] border border-border/60 shadow-sm">
          <CardContent className="flex min-h-105 flex-col items-center justify-center p-8 text-center">
            <div className="mb-4 flex size-16 items-center justify-center rounded-md bg-primary/10">
          ...
          <div className="flex flex-col items-start justify-between gap-5 md:flex-row">
            <div className="space-y-5">
              <div className="flex flex-wrap items-center gap-2">
                <Badge className="rounded-md border-0 bg-primary/10 p-3 text-xs font-medium text-primary hover:bg-primary/10">
                  لوحة التحكم
                </Badge>

                <Badge className="rounded-md border-0 bg-amber-700/10 p-3 text-xs font-medium text-amber-700 hover:bg-primary/10">
                  {getTodayDate()}
                </Badge>
