...
export function ConnectionStatus({ connection }: Props) {
  ...
  return (
    <Card
      className={cn(
        "border",
        isExpired ? "border-rose-500/30 bg-rose-500/5" : "border-emerald-500/30 bg-emerald-500/5",
      )}
    >
            ...
            <AlertDialog>
              ...
              <AlertDialogContent dir="rtl">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    سيتم حذف جميع المحادثات المحفوظة. الطلبات المقترحة ستبقى في
                    سجلك. لا يمكن التراجع عن هذا الإجراء.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
