...
export default async function OrderDetailsRoute({
  ...
  return (
    <div className="space-y-6 p-6" dir="rtl">
      {/* Header */}
      <div className="flex flex-col gap-4 rounded-md border bg-linear-to-r from-primary/10 via-primary/5 to-transparent p-5 md:flex-row md:items-center md:justify-between">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <Card className="rounded-md border-primary/15 shadow-sm">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        {/* Customer Info */}
        <Card className="rounded-md shadow-sm xl:col-span-2">
        ...
        <CardContent className="space-y-4">
          {order.items.length === 0 ? (
            ...
            order.items.map((item, index) => {
              ...
              return (
                <div key={item.id}>
                  <div className="flex flex-col gap-4 rounded-md border p-4 transition-colors hover:bg-muted/40 md:flex-row md:items-center md:justify-between">
                    <div className="space-y-2">
                    ...
                    <div className="rounded-md bg-primary/5 px-4 py-3 text-right">
