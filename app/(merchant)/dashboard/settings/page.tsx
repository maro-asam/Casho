    ...
    <div dir="rtl" className="space-y-6 p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          <Card className="rounded-lg shadow-sm bg-primary/10">
          ...
          <Card className="rounded-lg shadow-sm bg-orange-600/10">
            <CardHeader className="pb-3">
          ...
          <Card className="rounded-lg shadow-sm text-green-600 bg-green-600/10">
            <CardHeader className="pb-3">
          ...
          <Card className="rounded-lg shadow-sm text-red-600 bg-red-600/10">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-2 text-base">
