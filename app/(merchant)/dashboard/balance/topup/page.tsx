  ...
  return (
    <div className="min-h-[calc(100vh-120px)] bg-background p-4 md:p-6" dir="rtl">
      <div className="mx-auto flex w-full flex-col gap-6">
        <div className="flex flex-col gap-4 rounded-3xl border border-border/60 bg-card/60 p-6 shadow-sm backdrop-blur supports-backdrop-filter:bg-card/50 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
