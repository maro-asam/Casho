              ...
              {socialLinks.map((item, index) => {
                ...
                return (
                  <Link
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-lg border text-muted-foreground transition hover:bg-muted hover:text-foreground"
                  >
