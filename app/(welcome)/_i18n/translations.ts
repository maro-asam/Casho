...
export const translations = {
  ar: {
    ...
    pricing: {
      badge: "الأسعار",
      title: "ابدأ دلوقتي بسعر مناسب",
      titleAccent: "قبل ما العرض الحالي يخلص",
      subtitle: "حالياً الخطة الأساسية هي المتاحة للاشتراك، وباقي الخطط هتنزل قريب.",
      footnote:
  ...
  en: {
    ...
    pricing: {
      badge: "Pricing",
      title: "Start today at the right price",
      titleAccent: "before this offer ends",
      subtitle:
        "Currently only the basic plan is available. More plans are coming soon.",
      footnote:
        "After the first 50 merchant offer ends, all plans will be officially released.",
      currency: "EGP",
      soon: "Coming Soon",
      startNow: "Start Now",
      plans: [
        ...
        },
        {
          name: "Basic Plan",
          period: "/ mo",
          description: "The best choice for merchants who want to start professionally.",
          badge: "Available now for first 50 merchants",
          features: [
            "Full store with custom link",
            "Add products and categories",
            "Receive orders without customer accounts",
            "Payment methods for the Egyptian market",
            "Track order status",
        ...
        },
        {
          name: "Growth Plan",
          period: "/ mo",
          description: "For merchants who need more power as their business grows.",
          features: [
            "All Basic Plan features",
            "Additional features coming soon",
            "Stronger business management tools",
            "More scalable experience",
          ],
        },
      ],
    },
