    ...
    <section className="relative overflow-hidden py-16">
      <div className="wrapper mx-auto flex max-w-7xl flex-col items-center px-4 text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-md border border-primary/30 bg-primary/5 px-4 py-2 text-sm font-medium text-primary backdrop-blur-sm"
        >
        ...
        >
          <div className="absolute inset-x-10 bottom-0 h-24 rounded-md bg-primary/10 blur-3xl" />
          ...
          <div className="relative overflow-hidden rounded-[32px] border border-border/70 bg-background/80 p-4 shadow-[0_30px_100px_rgba(0,0,0,0.12)] backdrop-blur-xl md:p-6">
            <div className="mb-5 flex items-center justify-between rounded-md border border-border/60 bg-background/70 px-4 py-3">
            ...
            <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-3">
                  <motion.div
                    whileHover={{ y: -2 }}
                    className="rounded-md border border-border/60 bg-background/85 p-4 text-right"
                  >
                ...
                <div className="rounded-md border border-border/60 bg-background/85 p-5 text-right">
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {HERO_RECENT_ORDERS.map((order, index) => (
                      <motion.div
                        ...
                        className="flex items-center justify-between rounded-md border border-border/50 bg-background/80 p-3"
                      >
                ...
                <motion.div
                  ...
                  className="rounded-md border border-primary/15 bg-primary/5 p-5 text-right"
                >
                  ...
                  <div className="mt-4 flex items-center justify-between rounded-md border border-border/50 bg-background/70 px-3 py-2 text-xs">
          ...
          <motion.div
            ...
            className="absolute -right-2 top-8 hidden w-55 rounded-md border border-border/70 bg-background/85 p-3 shadow-xl backdrop-blur-xl md:block lg:-right-11"
          >
          ...
          <motion.div
            ...
            className="absolute -left-2 bottom-10 hidden w-55 rounded-md border border-border/70 bg-background/85 p-3 shadow-xl backdrop-blur-xl md:block lg:-left-11"
          >
            <div className="flex items-start gap-3 text-right">
              <div className="rounded-md bg-primary/10 p-2 text-primary">
                <Wallet className="size-4" />
