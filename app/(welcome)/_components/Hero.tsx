  ...
  return (
    <section className="relative overflow-hidden py-16">
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-1/2 -top-25 h-70 w-155 -translate-x-1/2 rounded-full bg-primary/10 blur-[110px]" />
        <div className="absolute -bottom-20 right-[15%] h-55 w-55 rounded-full bg-sky-300/20 blur-[100px]" />
