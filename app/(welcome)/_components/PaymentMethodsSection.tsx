...
export default function PaymentMethodsSection() {
  return (
    <section className="p-8 border border-primary/15 rounded-xl relative overflow-hidden">
      <div className="">
        {/* Logos */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-9 gap-6">
          {PAYMENT_LOGOS.map((logo, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group flex items-center justify-center rounded-xl border bg-transparent backdrop-blur-md p-3 hover:shadow-md transition-all"
            >
              <Image
                src={logo.src}
                alt={logo.alt}
