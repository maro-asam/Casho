  ...
  return (
    <header className="sticky top-4 z-50 mx-auto">
      <div className="mx-auto">
        <AnimatedNavbarShell>
          <div className="flex items-center justify-between rounded-full border border-border/5 bg-secondary px-4 py-3 backdrop-blur-5xl supports-backdrop-filter:bg-secondary/60 md:px-6">
            {/* Logo */}
              ...
              {user ? (
                <DropdownMenu dir="rtl" modal={false}>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="outline"
                      className="h-11 rounded-full border-border/10 px-3 transition-all duration-300"
                    >
                      <div className="flex items-center gap-2">
                        <div className="flex size-8 items-center justify-center rounded-full bg-primary/10 text-primary transition-transform duration-300">
