  ...
  return (
    <section className="relative overflow-hidden py-10 md:py-14 lg:py-20">
      ...
      <div className="absolute inset-0">
        <div className="absolute right-1/2 top-0 h-72 w-72 translate-x-1/2 rounded-md bg-primary/10 blur-3xl" />
        <div className="absolute bottom-0 left-1/4 h-64 w-64 rounded-md bg-primary/5 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
          {stats.map((item, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-md border border-zinc/10 bg-zinc/[0.03] p-6 backdrop-blur-sm transition duration-300 hover:border-primary/30 hover:bg-zinc/[0.05]"
            >
