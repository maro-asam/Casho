    ...
    <section className="py-10 md:py-14 lg:py-20">
      <div className="wrapper">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[32px] border border-border bg-linear-to-br from-card via-card to-primary/4 px-6 py-10 shadow-sm sm:px-8 md:px-10 md:py-14"
        >
          {/* background accents */}
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute right-[-60px] top-[-60px] h-40 w-40 rounded-md bg-primary/10 blur-3xl" />
            <div className="absolute left-[-40px] bottom-[-60px] h-36 w-36 rounded-md bg-sky-500/10 blur-3xl" />
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1.15fr_.85fr]">
            ...
            <div className="text-center lg:text-right">
              <div className="inline-flex items-center gap-2 rounded-md border border-primary/15 bg-primary/5 px-4 py-2 text-sm font-medium text-primary">
              ...
              <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
                <Button
                  asChild
                  size="lg"
                  className="h-12 rounded-md px-8 text-sm font-medium shadow-sm"
                >
                  <Link href="/signup">
                    ابدأ دلوقتي
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="h-12 rounded-md border-border bg-card px-8 text-sm font-medium"
                >
              ...
              <div className="rounded-[28px] border border-primary/15 bg-card p-5 shadow-sm">
                <div className="rounded-md border border-primary/15 bg-primary/[0.04] p-5">
                  ...
                  <div className="mt-3 flex items-end justify-between gap-4">
                    ...
                    <div className="rounded-md border border-primary/15 bg-white px-4 py-2 text-sm font-medium text-primary">
                      سعر خاص
                    </div>
                  </div>
                  ...
                  <div className="mt-5">
                    ...
                    <div className="h-2.5 overflow-hidden rounded-md bg-primary/10">
                      <div className="h-full w-2/3 rounded-md bg-primary" />
                    </div>
                  </div>
