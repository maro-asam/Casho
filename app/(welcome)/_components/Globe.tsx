...
export default function NetworkGlobe() {
  return (
    <div className="relative mx-auto flex h-[420px] w-full max-w-[520px] items-center justify-center">
      ...
      <div className="absolute bottom-12 left-10 h-28 w-28 rounded-full bg-sky-200/40 blur-3xl" />

      {/* globe shell */}
      <div className="relative flex h-[540px] w-[540px] items-center justify-center rounded-full border border-border/100 bg-background/60 shadow-[0_20px_80px_-20px_hsl(var(--primary)/0.20)] backdrop-blur-xl">
        {/* inner glow */}
        <div className="absolute inset-6 rounded-full bg-[radial-gradient(circle_at_center,hsl(var(--primary)/0.10),transparent_90%)]" />

        {/* globe grid */}
        <div className="absolute inset-0 overflow-hidden rounded-full">
          {/* horizontal lines */}
          <div className="absolute left-1/2 top-1/2 h-[78%] w-[78%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/20" />
          <div className="absolute left-1/2 top-1/2 h-[62%] w-[78%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/20" />
          <div className="absolute left-1/2 top-1/2 h-[46%] w-[78%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/20" />
          <div className="absolute left-1/2 top-1/2 h-[30%] w-[78%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/20" />

          {/* vertical lines */}
          <div className="absolute left-1/2 top-1/2 h-[78%] w-[28%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/20" />
          <div className="absolute left-1/2 top-1/2 h-[78%] w-[50%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/20" />
          <div className="absolute left-1/2 top-1/2 h-[78%] w-[68%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/20" />
        ...
        {pings.map((ping, index) => (
          ...
          >
            <span className="absolute left-1/2 top-1/2 block h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary" />
            <motion.span
              className="absolute left-1/2 top-1/2 block h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/50"
