    ...
    <section id="faq" className="py-10 md:py-14 lg:py-20">
      <div className="wrapper">
        ...
        <motion.div
          ...
          className="mx-auto mt-14 max-w-4xl rounded-md border border-border bg-card p-3 sm:p-4 md:p-5"
        >
          <Accordion type="single" collapsible className="w-full space-y-3">
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="overflow-hidden rounded-md border border-border bg-background px-5"
              >
