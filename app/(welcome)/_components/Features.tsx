      ...
      <div className="wrapper">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-5">
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl border border-border bg-card p-6 lg:col-span-2"
          >
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="rounded-3xl border border-border bg-card p-6 transition-opacity hover:opacity-95"
                >
