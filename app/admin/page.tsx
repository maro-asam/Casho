            ...
            {data.latestStores.length === 0 ? (
              ...
              data.latestStores.map((store) => (
                <Link
                  ...
                  className="group flex flex-col gap-4 rounded-3xl border border-border/60 bg-background p-4 transition-all duration-200 hover:border-primary/20 hover:bg-muted/30 hover:shadow-sm md:flex-row md:items-center md:justify-between"
                >
