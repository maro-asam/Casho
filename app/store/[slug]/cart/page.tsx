      ...
      <div className="mx-auto w-full py-8">
        <div className="mb-8 flex flex-col gap-4 rounded-xl border bg-background p-6 shadow-sm md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Badge variant="secondary" className="rounded-xl px-4 py-1.5 text-sm">
              {items.length} منتج
            </Badge>
        ...
        {items.length === 0 ? (
          <Card className="overflow-hidden rounded-xl border-0">
            <CardContent className="flex min-h-105 flex-col items-center justify-center px-6 py-16 text-center">
              <div className="mb-5 flex size-20 items-center justify-center rounded-xl bg-primary/10">
              ...
              <Card className="overflow-hidden rounded-[30px] border bg-background/95 backdrop-blur">
                <div className="bg-[linear-gradient(135deg,hsl(var(--primary)/0.14),transparent_55%)]">
                  <CardHeader className="pb-4">
                    <div className="mb-3 inline-flex w-fit items-center gap-2 rounded-xl border bg-background/80 px-3 py-1 text-xs font-medium">
