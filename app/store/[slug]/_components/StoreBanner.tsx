            ...
            <CarouselContent>
              {heroBanners.map((banner) => (
                <CarouselItem key={banner.id}>
                  <div className="relative h-55 w-full overflow-hidden rounded-md sm:h-70 md:h-85 xl:h-105">
                    <Image
                        ...
                        <div className="max-w-2xl space-y-3 text-white">
                          ...
                          <div className="flex flex-wrap items-center gap-3 pt-2">
                            <Button
                              asChild
                              size="lg"
                              className="rounded-md px-5 sm:px-6"
                            >
                              <Link
        ...
        {sideBanners.length > 0 && (
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {sideBanners.map((banner) => (
              <div
                key={banner.id}
                className="group relative h-42.5 w-full overflow-hidden rounded-md sm:h-47.5 lg:h-52.5"
              >
                <Image
                  src={banner.image || "/placeholder-banner.jpg"}
                  alt={banner.title}
