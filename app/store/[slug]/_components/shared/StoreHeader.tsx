            ...
            >
              ...
              <div className="hidden flex-1 lg:flex lg:max-w-xl">
                <form onSubmit={handleSearch} className="relative w-full">
                  <Input
                    ...
                    className="h-11 rounded-md border bg-background pl-12 pr-11 text-sm shadow-none"
                  />
                  ...
                  <Button
                    type="submit"
                    size="sm"
                    className="absolute left-1 top-1/2 h-9 -translate-y-1/2 rounded-md px-4"
                    disabled={isPending}
                  >
                    بحث
                  </Button>
              ...
              <div className="flex items-center gap-2">
                <Button
                  asChild
                  variant="outline"
                  className="relative h-11 rounded-md px-4"
                >
                  <Link
                  ...
                  >
                    ...
                    <span className="inline-flex min-w-5 items-center justify-center rounded-md bg-primary px-1.5 text-[11px] font-bold text-white">
                      {cartCount}
                    </span>
                  </Link>
                </Button>
                    ...
                    <SheetContent side="right" className="w-85 p-0" dir="rtl">
                      <div className="flex h-full flex-col">
                        ...
                        <div className="flex-1 space-y-6 overflow-y-auto px-5 py-5">
                          <Link
                            href={`/store/${storeSlug}`}
                            className="flex items-center gap-3 rounded-md border bg-card p-3 transition hover:bg-muted/40"
                          >
                          ...
                          <form onSubmit={handleSearch} className="relative">
                            <Input
                              ...
                              onChange={(e) => setSearch(e.target.value)}
                              placeholder="دور على منتج..."
                              className="h-11 rounded-md pl-12 pr-11"
                            />
                            <Search className="pointer-events-none absolute right-4 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                            <Button
                              type="submit"
                          ...
                          <SheetClose asChild>
                            <Button asChild className="h-11 w-full rounded-md">
                              ...
                              >
                                <ShoppingCart className="h-4 w-4" />
                                عرض العربة
                                <span className="inline-flex min-w-5 items-center justify-center rounded-md bg-white px-1.5 text-[11px] font-bold text-primary">
                                  {cartCount}
                                </span>
                              </Link>
                            </Button>
