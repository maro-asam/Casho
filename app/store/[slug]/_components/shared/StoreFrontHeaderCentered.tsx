            ...
            <SheetContent side="right" className="w-80 p-0" dir="rtl">
              <div className="flex h-full flex-col">
                ...
                <div className="space-y-2 px-5 py-5">
                  <SheetClose asChild>
                    <Link href={`/store/${storeSlug}`} className="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-muted">
                      <Store className="h-4 w-4 text-primary" />
                      الرئيسية
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link href={`/store/${storeSlug}/products`} className="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-muted">
                      <Search className="h-4 w-4 text-primary" />
                      المنتجات
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link href={`/store/${storeSlug}/categories`} className="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-muted">
                      <LayoutGrid className="h-4 w-4 text-primary" />
                      التصنيفات
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link href={`/store/${storeSlug}/about`} className="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-muted">
                      <Info className="h-4 w-4 text-primary" />
                      عن المتجر
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link href={`/store/${storeSlug}/contact`} className="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-muted">
