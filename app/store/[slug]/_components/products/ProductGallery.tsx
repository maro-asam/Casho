...
export default function ProductGallery({
  ...
  return (
    <div className="order-1 space-y-4 xl:order-1">
      <div className="h-fit overflow-hidden rounded-md border border-border/60 bg-card shadow-sm">
        <div className="p-4">
          ...
          {gallery.map((img, index) => {
            ...
            return (
              <button
                ...
                className={`relative h-28 w-28 overflow-hidden rounded-md border bg-muted/30 transition cursor-pointer ${
                  isActive
