              ...
              <div className="hidden flex-1 lg:flex lg:max-w-xl">
                <form onSubmit={handleSearch} className="relative w-full">
                  <Input
                    ...
                    className="h-11 border bg-background pl-12 pr-11 text-sm shadow-none"
                  />
                    ...
                    <SheetContent side="right" className="w-85 p-0" dir="rtl">
                      <div className="flex h-full flex-col">
                        ...
                        <div className="flex-1 space-y-6 overflow-y-auto px-5 py-5">
                          ...
                          >
                            <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden border bg-muted" style={{ borderRadius: `${logoRadius ?? 8}px` }}>
                              {logo ? (
                                <Image
                                  src={logo}
                                  alt={storeName}
