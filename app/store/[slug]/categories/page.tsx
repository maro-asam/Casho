...
export default async function StoreCategoriesPage({
  ...
  if (store.subscriptionStatus !== "active") {
    return (
      <div
        ...
        dir="rtl"
      >
        <Card className="w-full max-w-xl rounded-3xl border-destructive/20 bg-background shadow-sm">
  ...
  return (
    <div className="wrapper py-10 space-y-8" dir="rtl">
      <section className="relative overflow-hidden rounded-3xl border bg-background p-6 md:p-8">
        ...
        <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
          {categories.map((category, index) => (
            <Link
              ...
              className="group"
            >
              <Card className="h-full overflow-hidden rounded-3xl border bg-background transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-xl">
