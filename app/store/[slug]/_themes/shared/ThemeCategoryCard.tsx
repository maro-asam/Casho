        ...
        <Card className="overflow-hidden rounded-none border-0 bg-card p-0 shadow-none">
          <div className="relative aspect-square overflow-hidden bg-muted">
            ...
            <div className="absolute inset-x-0 bottom-0 p-4 text-white">
              <p className="mb-2 text-[10px] font-black uppercase tracking-[0.25em] text-white/60">
                Category
              </p>
    ...
    <Link href={href} prefetch={false} className="group block">
      <Card className="overflow-hidden rounded-none border-0 bg-card p-0 shadow-none">
        <div className="relative aspect-[3/4] overflow-hidden bg-muted">
          ...
          <div className="absolute right-4 top-4 border border-white/30 bg-black/25 px-3 py-1 text-[10px] font-black uppercase tracking-[0.28em] text-white backdrop-blur">
            Section
          </div>

          <div className="absolute inset-x-0 bottom-0 p-5 text-white">
            <p className="mb-3 text-[10px] font-black uppercase tracking-[0.32em] text-white/60">
              Magazine Category
            </p>

            <div className="flex items-end justify-between gap-4">
              <h3 className="line-clamp-2 text-3xl font-black uppercase leading-[0.9] tracking-[-0.04em]">
                {category.name}
              </h3>
